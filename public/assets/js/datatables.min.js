 ...
 *   https://datatables.net/download/#dt/dt-1.13.10/sb-1.6.0/sp-2.2.0
 *
 * Included libraries:
 *  DataTables 1.13.10, SearchBuilder 1.6.0, SearchPanes 2.2.0
 */
...
!function (n) {
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
        ...
        buttons: {},
        classes: {},
        builder: "dt/dt-1.13.10/sb-1.6.0/sp-2.2.0",
        errMode: "alert",
        feature: [],
        search: [],
...
!function (e) {
    ...
    "use strict";
    var I, c, a, d, l, h, p, m, e, i, r = s.fn.dataTable;
    ...
    function w(t, i, e, n, s, r, o) {
        void 0 === n && (n = 0), void 0 === s && (s = 1), void 0 === r && (r = V), void 0 === o && (o = !1);
        var a = this;
        if (!c || !c.versionCheck || !c.versionCheck("1.10.0")) throw new Error("SearchPane requires DataTables 1.10 or newer");
    ...
    return w._escapeHTML = function (t) {
        ...
        if (this.s.condition !== V && e !== V) {
            ...
            if (this.s.type.includes("num") && ("" !== this.s.dt.settings()[0].oLanguage.sDecimal || "" !== this.s.dt.settings()[0].oLanguage.sThousands)) {
                ...
                if ("" !== this.s.dt.settings()[0].oLanguage.sDecimal && (s = t[this.s.dataIdx].split(this.s.dt.settings()[0].oLanguage.sDecimal)), "" !== this.s.dt.settings()[0].oLanguage.sThousands) for (var r = 0; r < s.length; r++) s[r] = s[r].replace(this.s.dt.settings()[0].oLanguage.sThousands, ",");
                n = s.join(".")
            }
        ...
        if (void 0 === t && (t = !1), null === this.s.type || !this.s.type.includes("num") || "" === this.s.dt.settings()[0].oLanguage.sDecimal && "" === this.s.dt.settings()[0].oLanguage.sThousands) {
            if (null !== this.s.type && t) if (this.s.type.includes("date") || this.s.type.includes("time")) for (i = 0; i < this.s.value.length; i++) null === this.s.value[i].match(/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g) && (this.s.value[i] = ""); else if (this.s.type.includes("moment")) for (i = 0; i < this.s.value.length; i++) this.s.value[i] && 0 < this.s.value[i].length && o()(this.s.value[i], this.s.dateFormat, !0).isValid() && (this.s.value[i] = o()(this.s.value[i], this.s.dateFormat).format("YYYY-MM-DD HH:mm:ss")); else if (this.s.type.includes("luxon")) for (i = 0; i < this.s.value.length; i++) this.s.value[i] && 0 < this.s.value[i].length && null === f().DateTime.fromFormat(this.s.value[i], this.s.dateFormat).invalid && (this.s.value[i] = f().DateTime.fromFormat(this.s.value[i], this.s.dateFormat).toFormat("yyyy-MM-dd HH:mm:ss"))
        } else for (var i = 0; i < this.s.value.length; i++) {
            var e = [this.s.value[i].toString()];
            if ("" !== this.s.dt.settings()[0].oLanguage.sDecimal && (e = this.s.value[i].split(this.s.dt.settings()[0].oLanguage.sDecimal)), "" !== this.s.dt.settings()[0].oLanguage.sThousands) for (var n = 0; n < e.length; n++) e[n] = e[n].replace(this.s.dt.settings()[0].oLanguage.sThousands, ",");
        ...
        this.dom.data.unbind("change").on("change.dtsb", function () {
            ...
            for (var t = l.dom.condition.children("option." + l.classes.option), i = 0; i < t.length; i++) {
                ...
                if (e.val() === l.dom.condition.val()) {
                    ...
                    for (var n = e.val(), s = 0, r = Object.keys(l.s.conditions); s < r.length; s++) if (r[s] === n) {
                        l.s.condition = n;
                        break
                    }
        ...
        if (this.s.condition !== V) {
            if (0 < this.dom.value.length && this.dom.value[0] !== V) for (var t = 0, i = this.dom.value; t < i.length; t++) !function (t) {
        ...
        var t = [], i = Object.keys(this.s.conditions).length, e = this.s.dt.settings()[0].aoColumns,
        ...
        if (e[n].searchBuilder && e[n].searchBuilder.defaultCondition) {
            ...
            if ("number" == typeof f) this.dom.condition.prop("selectedIndex", f), this.dom.condition.trigger("change"); else if ("string" == typeof f) for (var g = 0; g < t.length; g++) for (var v = 0, b = Object.keys(this.s.conditions); v < b.length; v++) {
                var y, C = b[v];
        ...
        var t = this.s.dt.settings()[0].aoColumns, i = this.s.dt.columns(this.c.columns).indexes().toArray();
        ...
        this.s.filled = this.s.conditions[this.s.condition].isInputValid(this.dom.value, this), this.setListeners(), this.s.preventRedraw || t === this.s.filled || (this.s.dt.page.info().serverSide || this.doSearch(), this.setListeners())
    }, w.prototype._throttle = function (n, s) {
        var r = null, o = null, a = this;
        ...
        for (var s = e.dom.data.children("option:selected").val(), r = e.s.dt.rows().indexes().toArray(), o = e.s.dt.settings()[0], a = (e.dom.valueTitle.prop("selected", !0), I("<select/>").addClass(w.classes.value).addClass(w.classes.dropDown).addClass(w.classes.italic).addClass(w.classes.select).append(e.dom.valueTitle).on("change.dtsb", function () {
            ...
            var h = c[u],
                ...
                f = ("array" === e.s.type && (m.filter = Array.isArray(m.filter) ? m.filter : [m.filter], m.text = Array.isArray(m.text) ? m.text : [m.text]), function (t, i) {
                    ...
                    t = I("<option>", {
                        ...
                        value: t
                    }).data("sbv", t).addClass(e.classes.option).addClass(e.classes.notItalic).html("string" == typeof i ? i.replace(/(<([^>]+)>)/gi, "") : i), i = t.val();
            ...
            if (i) for (var g = 0; g < m.filter.length; g++) f(m.filter[g], m.text[g]); else f(m.filter, Array.isArray(m.text) ? m.text.join(", ") : m.text)
        }
        l.sort(function (t, i) {
        ...
        void 0 === t && (t = null);
        var s = e.s.dt.settings()[0].searchDelay, i = e.s.dt.i18n("datetime", {}),
        ...
        var i = this, s = (void 0 === t && (t = null), e.s.dt.settings()[0].searchDelay),
        ...
        if (t.s.filled = n.isInputValid(t.dom.value, t), t.s.value = n.inputValue(t.dom.value, t), t.s.filled) {
            ...
            for (var s = 0; s < t.s.value.length; s++) if (Array.isArray(t.s.value[s])) t.s.value[s].sort(); else if (t.s.type.includes("num") && ("" !== t.s.dt.settings()[0].oLanguage.sDecimal || "" !== t.s.dt.settings()[0].oLanguage.sThousands)) {
                var r = [t.s.value[s].toString()];
                if ("" !== t.s.dt.settings()[0].oLanguage.sDecimal && (r = t.s.value[s].split(t.s.dt.settings()[0].oLanguage.sDecimal)), "" !== t.s.dt.settings()[0].oLanguage.sThousands) for (var o = 0; o < r.length; o++) r[o] = r[o].replace(t.s.dt.settings()[0].oLanguage.sThousands, ",");
                t.s.value[s] = r.join(".")
            }
            for (var a = null, d = null, s = 0; s < t.dom.value.length; s++) i === t.dom.value[s][0] && (a = s, i.selectionStart !== V) && (d = i.selectionStart);
            (t.c.enterSearch || t.s.dt.settings()[0].oInit.search !== V && t.s.dt.settings()[0].oInit.search.return) && 13 !== e || t.doSearch(), null !== a && (t.dom.value[a].removeClass(t.classes.italic), t.dom.value[a].focus(), null !== d) && t.dom.value[a][0].setSelectionRange(d, d)
        } else (t.c.enterSearch || t.s.dt.settings()[0].oInit.search !== V && t.s.dt.settings()[0].oInit.search.return) && 13 !== e || t.doSearch()
    }, w.dateConditions = {
        "=": {
            ...
            }, init: w.initNoValue, inputValue: function () {
        ...
        "=": {
            ...
            isInputValid: w.isInputValidInput,
            search: function (t, i, e) {
                var t = o()(t, e.s.dateFormat).valueOf(), n = o()(i[0], e.s.dateFormat).valueOf(),
        ...
        "=": {
            ...
            isInputValid: w.isInputValidInput,
            search: function (t, i) {
                var t = w.parseNumFmt(t), e = w.parseNumFmt(i[0]), i = w.parseNumFmt(i[1]);
        ...
        if (!(t.criteria === V || null === t.criteria || Array.isArray(t.criteria) && 0 === t.criteria.length)) {
            if (this.s.logic = t.logic, this.dom.logic.children().first().html("OR" === this.s.logic ? this.s.dt.i18n("searchBuilder.logicOr", this.c.i18n.logicOr) : this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd)), Array.isArray(t.criteria)) for (var i = 0, e = t.criteria; i < e.length; i++) (n = e[i]).logic !== V ? this._addPrevGroup(n) : n.logic === V && this._addPrevCriteria(n);
            for (var n, s = 0, r = this.s.criteria; s < r.length; s++) (n = r[s]).criteria instanceof l && (n.criteria.updateArrows(1 < this.s.criteria.length), this._setCriteriaListeners(n.criteria))
        }
    }, g.prototype.redrawContents = function () {
        if (!this.s.preventRedraw) {
            this.dom.container.children().detach(), this.dom.container.append(this.dom.logicContainer).append(this.dom.add).append(this.dom.search), this.s.criteria.sort(function (t, i) {
        ...
        if (this.dom.logicContainer.remove(), this.dom.clear.remove(), this.s.criteria.length < 1) this.s.isChild || (this.dom.container.trigger("dtsb-destroy"), this.dom.container.css("margin-left", 0)), this.dom.search.css("display", "none"); else {
            ...
            var n = this.dom.container.outerHeight() - 1,
                ...
                s = n.left, s = s - (s - this.dom.container.offset().left) - this.dom.logicContainer.outerHeight(!0),
                s = (this.dom.logicContainer.offset({left: s}), this.dom.logicContainer.next()), n = n.top,
                s = a(s).offset().top;
        ...
        for (var t = 0, i = this.s.criteria; t < i.length; t++) {
            var e = i[t];
            if (e.criteria instanceof l && e.criteria.s.filled || e.criteria instanceof g && e.criteria.checkFilled()) return !0
        }
        return !1
        ...
        if (0 !== this.s.criteria.length) for (var e = 0, n = this.s.criteria; e < n.length; e++) {
            var s = n[e];
        ...
        if (void 0 === i && (i = !1), this.s.criteria.length <= 1 && this.s.isChild) this.destroy(); else {
        ...
        n.dom.delete.unbind("click").on("click.dtsb", function () {
            ...
            var t = n.s.index, i = new g(s.s.dt, s.s.opts, s.s.topGroup, n.s.index, !0, s.s.depth + 1, s.s.serverData);
            ...
            s.s.toDrop = new l(s.s.dt, s.s.opts, s.s.topGroup, n.s.index, V, s.s.serverData), s.s.toDrop.s = n.s, s.s.toDrop.c = n.c, s.s.toDrop.classes = n.classes, s.s.toDrop.populate();
        ...
        this.setListeners(), this.dom.add.html(this.s.dt.i18n("searchBuilder.add", this.c.i18n.add)), this.dom.search.html(this.s.dt.i18n("searchBuilder.search", this.c.i18n.search)), this.dom.logic.children().first().html("OR" === this.c.logic ? this.s.dt.i18n("searchBuilder.logicOr", this.c.i18n.logicOr) : this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd)), this.s.logic = "OR" === this.c.logic ? "OR" : "AND", this.c.greyscale && this.dom.logic.addClass(this.classes.greyscale), this.dom.logicContainer.append(this.dom.logic).append(this.dom.clear), this.s.isChild && this.dom.container.append(this.dom.logicContainer), this.dom.container.append(this.dom.add).append(this.dom.search)
        ...
        if (void 0 === t && (t = !0), h.fn.DataTable.Api.registerPlural("columns().type()", "column().type()", function () {
            ...
            if ((i = this.s.dt.columns().type().toArray()) === V || i.includes(V) || i.includes(null)) for (var i = [], e = 0, s = this.s.dt.settings()[0].aoColumns; e < s.length; e++) {
                var r = s[e];
        ...
        }), t.value1 = t.value[0], t.value2 = t.value[1]); else for (var i = 0; i < t.criteria.length; i++) t.criteria[i] = this._collapseArray(t.criteria[i]);
        return t
        ...
        var n = this, t = (this.dom.clearAll.remove(), this.dom.container.empty(), this.s.topGroup.count()),
        ...
        orthogonal: {display: "display", search: "filter"},
        preDefined: !1
    }, e = n, p = (h = s).fn.DataTable, d = (a = s).fn.dataTable, c = (I = s).fn.dataTable, i = s.fn.dataTable, r.SearchBuilder = e, i.SearchBuilder = e, r.Group = m, i.Group = m, r.Criteria = l, i.Criteria = l, i = r.Api.register, r.ext.searchBuilder = {conditions: {}}, r.ext.buttons.searchBuilder = {
    ...
    }),r.ext.feature.push({cFeature: "Q", fnInit: v}),r.ext.features && r.ext.features.register("searchBuilder", v),r
});
...
!function (n) {
    ...
    }) : "object" == typeof exports ? (d = require("jquery"), a = function (e, t) {
        t.fn.dataTable || require("datatables.net-dt")(e, t), t.fn.dataTable.SearchBuilder || require("datatables.net-searchbuilder")(e, t)
    }, "undefined" == typeof window ? module.exports = function (e, t) {
        return e = e || window, t = t || d(e), a(e, t), n(t, 0, e.document)
    } : (a(window, d), module.exports = n(d, window, window.document))) : n(jQuery, window, document)
}(function (e, t, n, d) {
    "use strict";
    return e.fn.dataTable
});
...
!function (e) {
    ...
    "use strict";
    var _, C, n, a, r, l, h, t, d, c, p, u, f, g, m, w, v, P, y, S, O, x, N, A, D, B = i.fn.dataTable;
        ...
        if (this.classes = P.extend(!0, {}, M.classes), this.c = P.extend(!0, {}, M.defaults, s), this.dom = {
            ...
            if (h === s) {
                ...
                for (var a = 0, i = l.s.selectionList; a < i.length; a++) {
                    var n = i[a], o = l.s.dt.column(n.column).dataSrc();
    ...
    function E(s, e, t) {
        ...
        }, t.config), a = new (a && (a.cascadePanes || a.viewTotal) ? B.SearchPanesST : B.SearchPanes)(s, a);
    ...
    return T.prototype.addRow = function (t, s, e, a, i, n, o) {
        ...
        var e = [], a = (this.s.serverSelect = [], null);
        return this.s.dtPane && (s && (this.s.dt.page.info().serverSide ? this.s.serverSelect = this.s.dtPane.rows({selected: !0}).data().toArray() : e = this.s.dtPane.rows({selected: !0}).data().toArray()), this.s.dtPane.clear().destroy(), a = this.dom.container.prev(), this.destroy(), this.s.dtPane = b, _.fn.dataTable.ext.search.push(this.s.searchFunction)), this.dom.container.removeClass(this.classes.hidden), this.s.displayed = !1, this._buildPane(this.s.dt.page.info().serverSide ? this.s.serverSelect : e, t, a), this
        ...
        this.s.dtPane && (this.s.dtPane.off("select.dtsp").on("select.dtsp", function () {
            ...
            d.s.deselectTimeout = setTimeout(function () {
                d._updateSelection(!0), 0 === d.s.dtPane.rows({selected: !0}).data().toArray().length && d.dom.clear.addClass(d.classes.disabledButton).attr("disabled", "true")
            }, 50)
            ...
            if (_.isEmptyObject(e)) d.s.dtPane.state.clear(); else {
                var a, i, n, o, r, l = [];
                d.s.dtPane && (l = d.s.dtPane.rows({selected: !0}).data().map(function (t) {
            ...
            d.s.dtPane.search(t).draw(), "string" == typeof t && (0 < t.length || 0 === t.length && 0 < d.s.dtPane.rows({selected: !0}).data().toArray().length) ? d.dom.clear.removeClass(d.classes.disabledButton).removeAttr("disabled") : d.dom.clear.addClass(d.classes.disabledButton).attr("disabled", "true"), d.s.dt.state.save()
        ...
        var t = this.s.dtPane.rows({selected: !0}).data().toArray().map(function (t) {
            return t.filter
        });
        ...
        if (t !== b) {
            var s = this.s.dt.rows(), e = s.data().toArray(), a = [];
            this.s.dtPane.clear(), this.s.indexes = [];
            for (var i = 0, n = t; i < n.length; i++) {
                var o = n[i], r = "" !== o.label ? o.label : this.emptyMessage(), l = {
        ...
        var a = this, t = C.Scroller, s = this.s.dt.settings()[0].oLanguage;
        ...
        if (t !== b) {
            ...
            if (s) for (var a = this.s.dtPane, i = a.rows({order: "index"}).data().map(function (t) {
        ...
        function s() {
            e.s.scrollTop = _(e.s.dtPane.table().node()).parent()[0].scrollTop, e.s.dt.page.info().serverSide && !e.s.updating ? e.s.serverSelecting || (e.s.serverSelect = e.s.dtPane.rows({selected: !0}).data().toArray(), e.s.dt.draw(!1)) : t && e._makeSelection(), i._fnProcessingDisplay(a, !1)
        }

        var e = this, a = this.s.dt.settings()[0], i = a.oApi;
        ...
        if (Array.isArray(t) || t instanceof C.Api) {
            ...
            sort: e,
            type: a
        })), this.s.rowData.totalOptions++) : i.push({display: s, filter: t, sort: e, type: a})
        ...
        var t = this.s.dt.settings()[0].aoColumns[this.s.index].searchPanes, s = _.extend(!0, {}, T.defaults, {
            collapse: null,
            emptyMessage: !1,
            initCollapsed: null,
            threshold: null
        ...
        var t = this.s.updating,
            ...
            e = s.indexOf(this.emptyMessage()), a = _(this.s.dtPane.table().container());
        ...
        return (c = Object.setPrototypeOf || ({__proto__: []} instanceof Array ? function (t, s) {
            t.__proto__ = s
        } : function (t, s) {
            for (var e in s) s.hasOwnProperty(e) && (t[e] = s[e])
        }))(t, s)
        ...
        this.s.rowData.arrayFilter = [], this.s.rowData.bins = {};
        var t = this.s.dt.settings()[0];
        if (!this.s.dt.page.info().serverSide) for (var s = 0, e = this.s.dt.rows({search: "applied"}).indexes().toArray(); s < e.length; s++) {
            var a = e[s];
            this._populatePaneArray(a, this.s.rowData.arrayFilter, t)
        }
        ...
        var t = this.s.colOpts.options || (this.s.customPaneSettings && this.s.customPaneSettings.options ? this.s.customPaneSettings.options : b);
        if (t !== b) {
            var s = this.s.dt.rows(), e = this.s.dt.rows({search: "applied"}), a = s.data().toArray(),
                i = e.data().toArray(), n = [];
            this.s.dtPane.clear(), this.s.indexes = [];
            for (var o = 0, r = t; o < r.length; o++) {
                var l = r[o], h = "" !== l.label ? l.label : this.emptyMessage(), d = {
        ...
        for (var t = 0, s = this.s.panes; t < s.length; t++) {
            var e, a = s[t];
            a.s.dtPane && (e = a.s.dtPane.rows({selected: !0}).data().toArray().map(function (t) {
                return t.filter
            })).length && this.s.selectionList.push({column: a.s.index, rows: e})
        }
            ...
            n = (!this.s.stateRead && a && this.s.dt.page(a.start / this.s.dt.page.len()).draw("page"), this.s.stateRead = !0, this._checkMessage(), i.on("preDraw.dtsps", function () {
                ...
                if (s === c) {
                    ...
                    for (var a = 0, i = 0, n = d.s.panes; i < n.length; i++) {
                        var o = n[i], r = d.s.dt.column(o.s.index).dataSrc();
                        if (e.searchPanes[r] || (e.searchPanes[r] = {}), e.searchPanes_null[r] || (e.searchPanes_null[r] = {}), o.s.dtPane) for (var l = o.s.dtPane.rows({selected: !0}).data().toArray(), h = 0; h < l.length; h++) e.searchPanes[r][h] = l[h].filter, e.searchPanes[r][h] || (e.searchPanes_null[r][h] = !0), a++
                    }
        ...
        return (x = Object.setPrototypeOf || ({__proto__: []} instanceof Array ? function (t, s) {
            t.__proto__ = s
        } : function (t, s) {
            for (var e in s) s.hasOwnProperty(e) && (t[e] = s[e])
        }))(t, s)
        ...
        for (var t = 0, s = this.s.panes; t < s.length; t++) {
            var e = s[t];
            if (e.s.colOpts.show) {
                var a = this.s.dt.column(e.s.index).dataSrc(), i = !0;
        ...
        var t;
        void 0 === s && (s = b), this.s.pagingST ? this.s.pagingST = !1 : this.s.updating || s && s.s.serverSelecting || (s !== b && (this.s.dt.page.info().serverSide && s._updateSelection(), t = s.s.dtPane.rows({selected: !0}).data().toArray().map(function (t) {
            return t.filter
        ...
        if (this.s.updating = !0, this.s.dt.page.info().serverSide) {
            ...
            var e = this.s.selectionList, a = !1;
            this.clearSelections(), this.s.dt.draw(!1), this.s.dt.rows().toArray()[0].length > this.s.dt.rows({search: "applied"}).toArray()[0].length && (a = !0), this.s.selectionList = e;
                ...
                if (h.s.dtPane) {
                    for (var u = h.s.dtPane.rows().indexes().toArray(), f = 0; f < l.rows.length; f++) {
                        for (var g = !1, m = 0, w = u; m < w.length; m++) {
                            var v = w[m], v = h.s.dtPane.row(v), P = v.data();
    ...
    }),B.ext.feature.push({cFeature: "P", fnInit: F}),B.ext.features && B.ext.features.register("searchPanes", F),B
});
...
!function (t) {
    ...
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-dt", "datatables.net-searchpanes"], function (e) {
        return t(e, window, document)
    }) : "object" == typeof exports ? (a = require("jquery"), d = function (e, n) {
